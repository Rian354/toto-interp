...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--probe-results-path", type=Path, nargs="+", required=True)
    ...
    parser.add_argument("--primary-method", type=str, default="linear_probe")
    parser.add_argument("--primary-weight-source", type=str, default="pretrained")
...
def main() -> None:
    ...
    write_report(
        ...
        primary_weight_source=args.primary_weight_source,
